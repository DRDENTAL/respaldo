...
<html>
  <head>
    ...
    <title>Sistema | INSTACLASS</title>
    ...
    <div class="wrapper">
      ...
      <header class="main-header">
        ...
        <a href="index" class="logo">
          ...
          <span class="logo-mini"><b>INSTACLASS</b></span>
          <!-- logo for regular state and mobile devices -->
          <span class="logo-lg"><img src="img/logony.png" width="140px" height="50px"></span>
        </a>
              ...
              <li class="dropdown user user-menu">
                ...
                <ul class="dropdown-menu">
                  ...
                  <li class="user-header">
                    ...
                    <p>
                     Usuario InstaClass
                      <small>Miembro desde Noviembre 2017</small>
                    </p>
                  </li>
                  <!-- Menu Body -->
                  <li class="user-body">
        ...
        <section class="sidebar">
          ...
          <ul class="sidebar-menu">
            ...
            <li class="treeview">
              ...
              <ul class="treeview-menu">
                <li class="active"><a href="javascript:void(0);" onclick="cargarformulario(2);" ><i class="fa fa-circle-o"></i>Cargar Datos Usuarios. </a></li>
                <li class="active"><a href="javascript:void(0);" onclick="cargarformulario(4);" ><i class="fa fa-circle-o"></i>Cargar Datos Colegios. </a></li>
