...
Route::get('/ingenieria.php', function () {
      return view('webpage.ingenieria');
  });
Route::get('/servicios.php', function () {
      return view('webpage.servicios');
  });
Route::get('/ofertas.php', function () {
      return view('webpage.ofertas');
  });
...
Route::group(['middleware' => 'usuarioAdmin'], function () {
    ...
    Route::get('form_cargar_datos_colegios', 'UsuariosController@form_cargar_datos_colegios');
      Route::post('cargar_datos_colegios', 'UsuariosController@cargar_datos_colegios');
